 ...
 *
 * Disassembly of SSDT-7.aml, Mon Nov 28 02:06:32 2016
 *
            ...
            Method (GSCI, 0, Serialized)
            {
                ...
                Method (SBCB, 0, Serialized)
                {
                    ...
                    If (LEqual (GESF, 0x07))
                    {
                        If (LEqual (S0ID, One))
                        {
                            If (LAnd (LLessEqual (OSYS, 0x07DD), LEqual (And (PARM, 0xFF), One)))
                            {
                                \GUAM (One)
                            }
                        }
                    ...
                    If (LEqual (GESF, 0x08))
                    {
                        If (LEqual (S0ID, One))
                        {
                            ...
                            If (LAnd (LLessEqual (OSYS, 0x07DD), LEqual (Local0, Zero)))
                            {
                                \GUAM (Zero)
                            }
                        }
